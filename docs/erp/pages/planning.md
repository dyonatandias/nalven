...
- Rota: `/erp/planning`
- API implementada: `/api/erp/planning`
- Grupo: FINANCEIRO
- Estado atual: **Implementado e verificado**
- SQL de referência: [planning.sql](../sql/planning.sql)
...
- `GET /api/erp/planning`: entrega catálogo, histórico e resumo derivados do tenant atual.
- `POST /api/erp/planning`: executa comandos validados, autorizados e auditados conforme o módulo.
