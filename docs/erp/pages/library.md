...
- Rota: `/erp/library`
- API implementada: `/api/erp/library`
- Grupo: GESTÃO
- Estado atual: **Implementado e verificado**
- SQL de referência: [library.sql](../sql/library.sql)
...
- `GET /api/erp/library`: entrega catálogo, histórico e resumo derivados do tenant atual.
- `POST /api/erp/library`: executa comandos validados, autorizados e auditados conforme o módulo.
