...
- Rota: `/erp/categories`
- API implementada: `/api/erp/categories`
- Grupo: CADASTROS
- Estado atual: **Implementado e verificado**
- SQL de referência: [categories.sql](../sql/categories.sql)
...
- `GET /api/erp/categories`: entrega catálogo, histórico e resumo derivados do tenant atual.
- `POST /api/erp/categories`: executa comandos validados, autorizados e auditados conforme o módulo.
