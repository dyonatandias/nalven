...
- Rota: `/erp/accounts`
- API implementada: `/api/erp/accounts`
- Grupo: FINANCEIRO
- Estado atual: **Implementado e verificado**
- SQL de referência: [accounts.sql](../sql/accounts.sql)
...
- `GET /api/erp/accounts`: entrega catálogo, histórico e resumo derivados do tenant atual.
- `POST /api/erp/accounts`: executa comandos validados, autorizados e auditados conforme o módulo.
