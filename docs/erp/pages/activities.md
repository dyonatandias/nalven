...
- Rota: `/erp/activities`
- API implementada: `/api/erp/activities`
- Grupo: GESTÃO
- Estado atual: **Implementado e verificado**
- SQL de referência: [activities.sql](../sql/activities.sql)
...
- `GET /api/erp/activities`: entrega catálogo, histórico e resumo derivados do tenant atual.
- `POST /api/erp/activities`: executa comandos validados, autorizados e auditados conforme o módulo.
