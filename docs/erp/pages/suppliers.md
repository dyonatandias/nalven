...
- Rota: `/erp/suppliers`
- API implementada: `/api/erp/suppliers`
- Grupo: CADASTROS
- Estado atual: **Implementado e verificado**
- SQL de referência: [suppliers.sql](../sql/suppliers.sql)
...
- `GET /api/erp/suppliers`: entrega catálogo, histórico e resumo derivados do tenant atual.
- `POST /api/erp/suppliers`: executa comandos validados, autorizados e auditados conforme o módulo.
