...
- Rota: `/erp/sales`
- API implementada: `/api/erp/sales`
- Grupo: OPERAÇÃO
- Estado atual: **Implementado e verificado**
- SQL de referência: [sales.sql](../sql/sales.sql)
...
- `GET /api/erp/sales`: entrega catálogo, histórico e resumo derivados do tenant atual.
- `POST /api/erp/sales`: executa comandos validados, autorizados e auditados conforme o módulo.
