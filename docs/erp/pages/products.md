...
- Rota: `/erp/products`
- API implementada: `/api/erp/products`
- Grupo: OPERAÇÃO
- Estado atual: **Implementado e verificado**
- SQL de referência: [products.sql](../sql/products.sql)
...
- `GET /api/erp/products`: entrega catálogo, histórico e resumo derivados do tenant atual.
- `POST /api/erp/products`: executa comandos validados, autorizados e auditados conforme o módulo.
