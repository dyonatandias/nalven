...
- Rota: `/erp/invoices`
- API implementada: `/api/erp/invoices`
- Grupo: OPERAÇÃO
- Estado atual: **Implementado e verificado**
- SQL de referência: [invoices.sql](../sql/invoices.sql)
...
- `GET /api/erp/invoices`: entrega catálogo, histórico e resumo derivados do tenant atual.
- `POST /api/erp/invoices`: executa comandos validados, autorizados e auditados conforme o módulo.
