...
- Rota: `/erp`
- API implementada: `/api/erp/dashboard`
- Grupo: OPERAÇÃO
- Estado atual: **Implementado e verificado**
- SQL de referência: [dashboard.sql](../sql/dashboard.sql)
...
- `GET /api/erp/dashboard`: entrega catálogo, histórico e resumo derivados do tenant atual.
- `POST /api/erp/dashboard`: executa comandos validados, autorizados e auditados conforme o módulo.
