...
type Data = { name: string; domain: string; trialDays: number; dueDay: number; paymentMethods: string[]; plans: { id: string; name: string; visibility: string; active: boolean; billingCode: string }[]; versions: { saas: string | null; signup: string | null } };
export default function PlatformSettings() {
  ...
  useEffect(() => {
    ...
    void (async () => { try {
      ...
      if (!Array.isArray(result.plans) || !Array.isArray(result.paymentMethods) || !result.versions) throw new Error("Configuração inválida.");
